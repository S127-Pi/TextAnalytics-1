...
model_results <- data.frame("Model" = c("Logistic Regression", "Lasso", "Random Forest"), "Accuracy" = c(accuracy_logi, accuracy_lasso, accuracy_rf), "Log Likelihood" = c(log_likeli_logistic, log_likeli_lasso, log_likeli_rf))
