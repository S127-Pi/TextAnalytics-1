...
get_top_similar_words("artist")
get_top_similar_words("book")
```
...
```{r 1.3}
arithmetic <- model[which("knight" == rownames(model)),] - 
  model[which("movi" == rownames(model)),] + 
  model[which("toi" == rownames(model)),]
